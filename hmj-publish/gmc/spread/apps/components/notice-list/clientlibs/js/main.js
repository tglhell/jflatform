(function (global, factory) {
    global = global;
    global.g2 = global.g2 || {};
    global.g2.supportNoticeList = global.g2.supportNoticeList || {};
    global.g2.supportNoticeList.Component = factory();
    ...
    var Component = (function (isUndefined) {
        ...
        function Component (container, args) {
            ...
            var defParams = {
                obj : container,
                animateList : '.cp-notice-list__list-inner',
                animateChild : '.cp-notice-list__box',
        ...
        Component.prototype = {
            ...
            callComponent : function () {
                for (var i = 0, max = this.obj.length; i < max; i++) {
                    new win.g2.supportNoticeList.Component(this.obj.eq(i));
                }
            }
        };
