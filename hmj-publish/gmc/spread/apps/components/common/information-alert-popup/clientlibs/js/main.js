(function (global, factory) {
    global = global;
    global.g2 = global.g2 || {};
    global.g2.infoAlertLayer = global.g2.infoAlertLayer || {};
    global.g2.infoAlertLayer.Component = factory();
    ...
    var Component = (function (isUndefined) {
        ...
        function Component (container, args) {
            ...
            var defParams = {
                ...
                infoWrap : '.information-alert-popup__info',
        ...
        Component.prototype = {
            ...
            callComponent : function () {
                for (var i = 0, max = this.obj.length; i < max; i++) {
                    new win.g2.infoAlertLayer.Component(this.obj.eq(i));
                }
            }
        };
