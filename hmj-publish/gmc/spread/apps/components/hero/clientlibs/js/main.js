(function (global, factory) {
    global = global;
    global.g2 = global.g2 || {};
    global.g2.cpHero = global.g2.cpHero || {};
    global.g2.cpHero.Component = factory();
    ...
    var Component = (function (isUndefined) {
        ...
        Component.prototype = {
            ...
            bindEvents : function () {
                this.scrollBtn.on(this.changeEvents('click'), $.proxy(this.scrollBtnClick, this));
            },
        ...
        Component.prototype = {
            ...
            callComponent : function () {
                for (var i = 0, max = this.obj.length; i < max; i++) {
                    new win.g2.cpHero.Component(this.obj.eq(i));
                }
            }
        };
