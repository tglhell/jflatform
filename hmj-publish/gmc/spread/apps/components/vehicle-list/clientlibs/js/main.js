(function (global, factory) {
    global = global;
    global.g2 = global.g2 || {};
    global.g2.cpVehicleList = global.g2.cpVehicleList || {};
    global.g2.cpVehicleList.Component = factory();
    ...
    var Component = (function (isUndefined) {
        ...
        Component.prototype = {
            ...
            buildHeightMatch : function () {
                Util.def(this, {
                    heightmatch : {
                        instance : [],
                        matchElements : ['.cp-vehicle-list__tab-title', '.cp-vehicle-list__tab-item-inner'],
                        matchCommonOpts : {
            ...
            buildAnimation : function () {
                for (var i = 0, max = this.slides.length; i < max; i++) {
                    new ViewAnimation(this.slides.eq(i));
                }
            },
        ...
        function ViewAnimation (container, args) {
            ...
            var defParams = {
                itemInner : '.cp-vehicle-list__tab-item-inner',
                directionTweenOpts : {
                    smagicOpts : {
                        triggerHook : 0.9
                    },
        ...
        ViewAnimation.prototype = {
            ...
            buildTween : function () {
                new DirectionTween(this.itemInner, this.opts.directionTweenOpts);
            }
        };
        ...
        Component.prototype = {
            ...
            callComponent : function () {
                for (var i = 0, max = this.obj.length; i < max; i++) {
                    new win.g2.cpVehicleList.Component(this.obj.eq(i));
                }
            }
        };
