(function (global, factory) {
    global = global;
    global.g2 = global.g2 || {};
    global.g2.supportPRList = global.g2.supportPRList || {};
    global.g2.supportPRList.Component = factory();
    ...
    var Component = (function (isUndefined) {
        ...
        function Component (container, args) {
            ...
            var defParams = {
                obj : container,
                animateList : '.cp-news-list__list',
                animateChild : '.cp-news-list__box',
        ...
        Component.prototype = {
            ...
            callComponent : function () {
                for (var i = 0, max = this.obj.length; i < max; i++) {
                    new win.g2.supportPRList.Component(this.obj.eq(i));
                }
            }
        };
